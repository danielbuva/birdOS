...
# still invokes S03danilauncher as the stock-compatible fallback.
FIRST_FRAME_MARKER="/run/muos/dani-first-frame-ready"
COUNT=0

/opt/muos/script/init/S03danilauncher start || exit 0
