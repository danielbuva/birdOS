...
# content bytes stay untouched. V6.22 adds one Bird-wide foreground exit
# contract and replaces the crashing blueMSX route with ROCKNIX's fMSX core.
...
printf 'Bird stock-root v6.22 staged on /dev/%s.\n' "$WHOLE"
