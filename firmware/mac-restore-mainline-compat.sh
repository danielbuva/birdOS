...
[ "$ACTION" = '--restore' ] || \
	fail "usage: $0 /Volumes/BIRD-DATA --restore"
...
[ "$CURRENT_SHA" = "$CANDIDATE_SHA" ] || \
	fail "refusing unknown boot image: $CURRENT_SHA"
