...
case "${BIRD_KERNEL_AUTHORITY:-stock}" in
	...
	source-irq-buttons|source-irq-buttons-lz4|source-no-raid6-benchmark) JOYPAD_SHA=fd2ceb95f0b3bdc1d68e7182a8ac5239b5286cc277a04980e53f65e0f73d3a05; EMBED_JOYPAD=0 ;;
