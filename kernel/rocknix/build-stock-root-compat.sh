...
case "$KERNEL_AUTHORITY" in
	stock)
		...
		;;
	source-parity)
		KERNEL_SHA=1d1e950eac7af564dfb3d439d3029989ea0e1ff5bd036cc19bda820f4d1cc9cd
		DTB_SHA=f3a4273986d6e4f431b110cead8aa19e8da52ff08c64c4b204ef9664d28b5c31
	...
	source-single-gpio-read)
		KERNEL_SHA=1dfa7e4a740a79ee9814c2da54080a0d843e874f5ec92fbd1fb91e58a9c8c2b5
		DTB_SHA=f3a4273986d6e4f431b110cead8aa19e8da52ff08c64c4b204ef9664d28b5c31
		SYSTEM_SHA=57210b5cb6072bf1e2b81dea31df76f9b5d4aab5534d7d3b668fdfdc51a1c527
		JOYPAD_SHA=fd2ceb95f0b3bdc1d68e7182a8ac5239b5286cc277a04980e53f65e0f73d3a05
		KERNEL_PROVIDER='bird-source-single-gpio-read:linux-7.0.11:Image'
		DTB_PROVIDER='bird-source-single-gpio-read:ROCKNIX-H700:dtb.img'
		SYSTEM_PROVIDER='bird-source-single-gpio-read:accepted-builtin-input-SYSTEM'
		JOYPAD_PROVIDER='bird-source-single-gpio-read:build-oracle:rocknix-singleadc-joypad.ko'
		;;
	source-single-input-sync)
		KERNEL_SHA=7c37f4faad42326926740286f1b9d8d2beb461d31751d81103c25d9baa44bde3
		DTB_SHA=f3a4273986d6e4f431b110cead8aa19e8da52ff08c64c4b204ef9664d28b5c31
		SYSTEM_SHA=57210b5cb6072bf1e2b81dea31df76f9b5d4aab5534d7d3b668fdfdc51a1c527
		JOYPAD_SHA=fd2ceb95f0b3bdc1d68e7182a8ac5239b5286cc277a04980e53f65e0f73d3a05
		KERNEL_PROVIDER='bird-source-single-input-sync:linux-7.0.11:Image'
		DTB_PROVIDER='bird-source-single-input-sync:ROCKNIX-H700:dtb.img'
		SYSTEM_PROVIDER='bird-source-single-input-sync:accepted-builtin-input-SYSTEM'
		JOYPAD_PROVIDER='bird-source-single-input-sync:build-oracle:rocknix-singleadc-joypad.ko'
		;;
	source-changed-input-sync)
		KERNEL_SHA=856fb5b4ac23b28cd7fdaebb39278d47824d087e40450f8af5014c8d1249eb6a
		DTB_SHA=f3a4273986d6e4f431b110cead8aa19e8da52ff08c64c4b204ef9664d28b5c31
		SYSTEM_SHA=57210b5cb6072bf1e2b81dea31df76f9b5d4aab5534d7d3b668fdfdc51a1c527
		JOYPAD_SHA=fd2ceb95f0b3bdc1d68e7182a8ac5239b5286cc277a04980e53f65e0f73d3a05
		KERNEL_PROVIDER='bird-source-changed-input-sync:linux-7.0.11:Image'
		DTB_PROVIDER='bird-source-changed-input-sync:ROCKNIX-H700:dtb.img'
		SYSTEM_PROVIDER='bird-source-changed-input-sync:accepted-builtin-input-SYSTEM'
		JOYPAD_PROVIDER='bird-source-changed-input-sync:build-oracle:rocknix-singleadc-joypad.ko'
		;;
	source-fixed-gpio-fastpath)
		KERNEL_SHA=e112527fac5790b4dfee8a5381224ff15dffc84a16e64202c46c981335b3b549
		DTB_SHA=f3a4273986d6e4f431b110cead8aa19e8da52ff08c64c4b204ef9664d28b5c31
		SYSTEM_SHA=57210b5cb6072bf1e2b81dea31df76f9b5d4aab5534d7d3b668fdfdc51a1c527
		JOYPAD_SHA=fd2ceb95f0b3bdc1d68e7182a8ac5239b5286cc277a04980e53f65e0f73d3a05
		KERNEL_PROVIDER='bird-source-fixed-gpio-fastpath:linux-7.0.11:Image'
		DTB_PROVIDER='bird-source-fixed-gpio-fastpath:ROCKNIX-H700:dtb.img'
		SYSTEM_PROVIDER='bird-source-fixed-gpio-fastpath:accepted-builtin-input-SYSTEM'
		JOYPAD_PROVIDER='bird-source-fixed-gpio-fastpath:build-oracle:rocknix-singleadc-joypad.ko'
		;;
	source-irq-buttons)
		...
		SYSTEM_SHA=57210b5cb6072bf1e2b81dea31df76f9b5d4aab5534d7d3b668fdfdc51a1c527
		JOYPAD_SHA=fd2ceb95f0b3bdc1d68e7182a8ac5239b5286cc277a04980e53f65e0f73d3a05
		KERNEL_PROVIDER='bird-source-irq-buttons:linux-7.0.11:Image'
	...
	source-deferred-wifi)
		KERNEL_SHA=05f3b40c4d1c2b4255745b9814052b9e1d091f22f9bd1499a5841b41b24771bc
		DTB_SHA=f3a4273986d6e4f431b110cead8aa19e8da52ff08c64c4b204ef9664d28b5c31
		SYSTEM_SHA=57210b5cb6072bf1e2b81dea31df76f9b5d4aab5534d7d3b668fdfdc51a1c527
		JOYPAD_SHA=fd2ceb95f0b3bdc1d68e7182a8ac5239b5286cc277a04980e53f65e0f73d3a05
		KERNEL_PROVIDER='bird-source-irq-buttons:no-raid6-pq-benchmark:deferred-wifi-sdio-power:linux-7.0.11:Image:lz4-v1.10.0--9-T1'
		DTB_PROVIDER='bird-source-irq-buttons:ROCKNIX-H700:dtb.img'
		SYSTEM_PROVIDER='bird-source-irq-buttons:accepted-builtin-input-SYSTEM'
		JOYPAD_PROVIDER='bird-source-irq-buttons:build-oracle:rocknix-singleadc-joypad.ko'
		;;
...
case "$KERNEL_AUTHORITY" in
	...
	source-single-gpio-read) SOURCE_KERNEL_AUTHORITY_SHA=d4d3977294603f15085e38972370795d7932cb503110f7eddec104dfecab0194 ;;
	source-single-input-sync) SOURCE_KERNEL_AUTHORITY_SHA=afe2693b5a632170b638eda70f27a77198ca89e2b792dfa5628f5057a8f49fa8 ;;
	...
	source-deferred-wifi) SOURCE_KERNEL_AUTHORITY_SHA=9469c0832d135340ff7839244dbe9ef42add6edb7f66b034a4a11e434fd14041 ;;
...
build_bird_local_binary bird-input-tester bird-input-tester
...
grep -q '^#define ACTION_INPUT_TESTER 15$' \
	"$ROOT/launcher/bird-launcher.c" || fail 'launcher input tester action missing'
grep -Fq 'INPUT_TESTER=/flash/bird/bird-input-tester' \
	"$OUTPUT/card/bird/supervisor.sh" || fail 'input tester supervisor path missing'
grep -Fq '15) consume_handoff_action && run_input_tester ;;' \
	"$OUTPUT/card/bird/supervisor.sh" || fail 'input tester early handoff missing'
grep -Fq '15) run_input_tester ;;' \
	"$OUTPUT/card/bird/supervisor.sh" || fail 'input tester final dispatch missing'
grep -Fq 'static const char *play_item[2] = {"SYSTEMS", "FAVORITES"};' \
	"$ROOT/launcher/bird-launcher.c" || fail 'Play hierarchy changed'
grep -Fq 'static const char *tools_item[2] = {"INPUT TESTER", "PORTMASTER"};' \
