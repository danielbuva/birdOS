...
95 percent. The temporary capture path is retired from the next canonical
...
MBR/FAT read-path successor is sealed and host-ready. That successor's physical
gate and inherited-frame work remain.
