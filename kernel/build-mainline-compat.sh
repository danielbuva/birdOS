...
docker run --rm --platform linux/arm64 \
	...
	"$IMAGE" sh -eu -c '
		...
		cp -f arch/arm64/boot/dts/allwinner/sun50i-h700-anbernic-rg34xx-sp-bird.dtb \
			/workspace/kernel/work/mainline-compat/
		scripts/dtc/dtc -q -I dtb -O dts \
			-o /workspace/kernel/work/mainline-compat/built.dts \
			arch/arm64/boot/dts/allwinner/sun50i-h700-anbernic-rg34xx-sp-bird.dtb
