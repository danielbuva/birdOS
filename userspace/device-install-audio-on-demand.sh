...
DBUS_REAL="/opt/muos/script/init/.S30dbus.bird-real"
PW_BACKUP="$WORK_DIR/backup/pipewire.sh.stock"
DBUS_BACKUP="$WORK_DIR/backup/S30dbus.stock"
LAUNCHER_BACKUP="$WORK_DIR/backup/S03birdlauncher.pre-audio-demand"
...
PW_TEMP="$PW_TARGET.bird-new"
DBUS_TEMP="$DBUS_TARGET.bird-new"
LAUNCHER_TEMP="$LAUNCHER_TARGET.bird-new"
INSTALL_STARTED=0
